...
CONCAT("$",FORMAT(SUM(CASE WHEN ( orders_fact.probability = "100" AND dim_issue.issue_cover_date BETWEEN "2018-01-01" AND "2019-01-01") THEN sales_fact.net ELSE 0 END),2)) AS '2018 Total Net 100%',
CONCAT("$",FORMAT(SUM(CASE WHEN ( orders_fact.probability = "100" AND dim_issue.issue_cover_date BETWEEN "2017-01-01" AND "2018-01-01") THEN sales_fact.net ELSE 0 END),2)) AS '2017 Total Net 100%',
...
AND dim_issue.issue_cover_date BETWEEN "2016-01-01" AND "2019-01-01"
